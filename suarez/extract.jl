...
Use API to Holy Cross suarez AI to extract morphological data and short definitions from Liddell-Scott.

Three sections:

1. configure suarez
2. get LSJ data
3. query a range of LSJ and write results to files
=#
...
extractrange(13000, 50999, ls; outputroot = outputdir, bearerkey = "sk-ff7e8eb3ed834982b52697c558a4db81")
